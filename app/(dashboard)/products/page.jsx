...
export default function ProductPage() {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/sales/getAllOrders`);
  ...
  const handleEditSubmit = async (event) => {
    ...
    try {
      await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/product/editProduct`, {
        productId: id,
        name: name || undefined,
  ...
  const handleAddImageSubmit = async (event) => {
    ...
    try {
      await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/product/addNewImage`, {
